...
import com.j0ach1mmall3.freeautomessage.api.internal.objects.Subtitle;
...
/**
 * Created by j0ach1mmall3 on 18:05 18/08/2015 using IntelliJ IDEA.
 */
public class SubtitleBroadcaster extends Broadcaster {
    ...
    public void broadcast() {
        ...
        for(Player p : Bukkit.getOnlinePlayers()) {
            if(p.hasPermission(permission) && enabledWorlds.contains(p.getWorld().getName())) new Subtitle(p, messages.get(id), fadeIn, stay, fadeOut).send();
        }
    }
}
